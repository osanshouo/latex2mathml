...
impl Token {
    pub fn from_command(command: &str) -> Token {
        match command {
            ...
            "overbrace"  => Token::Overbrace,
            "underbrace" => Token::Underbrace,
            "!"     => Token::Space(-3./18.),
            ","     => Token::Space(3./18.),
            ":"     => Token::Space(4./18.),
            ";"     => Token::Space(5./18.),
            ...
            "th"         => Token::Letter('þ', Variant::Normal),
            "imath"      => Token::Letter('ı', Variant::Normal),
            "jmath"      => Token::Letter('ȷ', Variant::Normal),
            "ell"        => Token::Letter('ℓ', Variant::Normal),
            "hbar"       => Token::Letter('ℏ', Variant::Normal),
            "hslash"     => Token::Letter('ℏ', Variant::Normal),
            ...
            "checkmark"  => Token::Letter('X', Variant::Normal),
